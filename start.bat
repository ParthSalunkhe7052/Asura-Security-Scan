...
start "ASURA Backend - http://localhost:8000" cmd /k "cd backend && .\venv\Scripts\activate && echo. && echo ======================================== && echo    ASURA Backend Server && echo ======================================== && echo. && uvicorn app.main:app --reload"
